...
**Batch handling:** Work from the submission manifest, but accept, hold or reject each bag independently. The receiving-run membership records the lab barcode and current location for every accepted line.

...
**Batch handling:** The charge-loading queue shows eligible pulps individually. An accepted charge becomes a named future assay-batch member only after its own mass/tolerance check passes.

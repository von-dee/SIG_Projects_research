...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Global Dashboard](./README.md) → KPI Overview

## Purpose

Live delegate check-ins, revenue, sponsorship attainment, delegation count, and hotel occupancy. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

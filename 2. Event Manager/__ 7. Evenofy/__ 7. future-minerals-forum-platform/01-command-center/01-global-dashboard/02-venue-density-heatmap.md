...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Global Dashboard](./README.md) → Venue Density Heatmap

## Purpose

Live density view for plenary halls, exhibition areas, and VIP zones using approved badge signals. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

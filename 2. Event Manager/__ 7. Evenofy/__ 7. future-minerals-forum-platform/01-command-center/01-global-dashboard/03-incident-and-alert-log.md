...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Global Dashboard](./README.md) → Incident & Alert Log

## Purpose

Severity-coded operational feed from zone managers, security, medical, and facilities teams. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

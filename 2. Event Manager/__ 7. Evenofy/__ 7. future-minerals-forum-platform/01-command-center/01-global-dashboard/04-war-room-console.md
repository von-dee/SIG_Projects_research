...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Global Dashboard](./README.md) → War Room Console

## Purpose

Crisis command view for VIP no-shows, schedule cascades, lockdown decisions, and evacuation broadcasts. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

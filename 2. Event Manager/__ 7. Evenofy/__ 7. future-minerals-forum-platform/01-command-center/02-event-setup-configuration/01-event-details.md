...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Event Setup & Configuration](./README.md) → Event Details

## Purpose

Event identity, dates, Riyadh venue address, and multi-building map assets. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

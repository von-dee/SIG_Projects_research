...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Event Setup & Configuration](./README.md) → Access Matrix Builder

## Purpose

Page-level and zone-level credential tiers for principals, delegations, media, security, and staff. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

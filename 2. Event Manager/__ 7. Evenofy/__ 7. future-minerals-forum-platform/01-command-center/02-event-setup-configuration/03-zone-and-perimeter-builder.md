# Zone & Perimeter Builder

> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Event Setup & Configuration](./README.md) → Zone & Perimeter Builder

## Purpose

Red and green zones, checkpoints, and motorcade routes over the approved venue map. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Event Director, Operations Team, and War Room Staff.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Run of Show (ROS) Engine](./README.md) → Cue Sheet Generator

## Purpose

Printable AV, lighting, teleprompter, and interpretation cues tied to timecodes. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

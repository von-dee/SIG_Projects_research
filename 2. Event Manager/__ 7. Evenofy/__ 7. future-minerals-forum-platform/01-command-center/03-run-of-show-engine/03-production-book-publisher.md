...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Command Center](../README.md) → [Run of Show (ROS) Engine](./README.md) → Production Book Publisher

## Purpose

Controlled compilation and distribution of the locked run of show as the Production Book PDF. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Venue Operations](../README.md) → [Floorplan Builder](./README.md) → CAD Upload & Mapping

## Purpose

Ingest, version, and align venue blueprints. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

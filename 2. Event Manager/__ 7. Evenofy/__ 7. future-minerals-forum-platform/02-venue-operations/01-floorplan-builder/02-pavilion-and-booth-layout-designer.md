# Pavilion & Booth Layout Designer

> **Breadcrumb:** [FMF Platform](../../README.md) → [Venue Operations](../README.md) → [Floorplan Builder](./README.md) → Pavilion & Booth Layout Designer

## Purpose

Place country pavilions, sponsor booths, fire exits, ministerial lounges, and the media center. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

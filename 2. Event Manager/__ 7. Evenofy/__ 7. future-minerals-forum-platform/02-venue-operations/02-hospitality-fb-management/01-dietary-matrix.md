...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Venue Operations](../README.md) → [Hospitality & F&B Management](./README.md) → Dietary Matrix

## Purpose

Aggregate halal, vegan, gluten-free, and allergen needs for every service. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

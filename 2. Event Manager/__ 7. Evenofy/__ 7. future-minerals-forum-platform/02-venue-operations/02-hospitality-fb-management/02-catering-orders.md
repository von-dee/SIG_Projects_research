...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Venue Operations](../README.md) → [Hospitality & F&B Management](./README.md) → Catering Orders

## Purpose

Vendor-linked orders by lounge, pavilion, and function. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

# Banquet Seating Planner

> **Breadcrumb:** [FMF Platform](../../README.md) → [Venue Operations](../README.md) → [Hospitality & F&B Management](./README.md) → Banquet Seating Planner

## Purpose

Protocol-sensitive state-dinner charts that respect precedence and rank. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

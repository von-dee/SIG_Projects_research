...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Venue Operations](../README.md) → [Asset, Staff & Transport Management](./README.md) → Asset Tracker

## Purpose

QR check-out and return for operational equipment. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

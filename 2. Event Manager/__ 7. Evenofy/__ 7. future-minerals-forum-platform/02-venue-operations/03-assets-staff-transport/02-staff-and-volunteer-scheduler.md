# Staff & Volunteer Scheduler

> **Breadcrumb:** [FMF Platform](../../README.md) → [Venue Operations](../README.md) → [Asset, Staff & Transport Management](./README.md) → Staff & Volunteer Scheduler

## Purpose

Shift planning with geofence clock-in and radio assignments. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

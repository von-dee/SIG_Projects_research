...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Commercial & Finance](../README.md) → [Sponsorship Tiers & Packages](./README.md) → Tier Builder

## Purpose

Create sponsor packages and their contracted benefits. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

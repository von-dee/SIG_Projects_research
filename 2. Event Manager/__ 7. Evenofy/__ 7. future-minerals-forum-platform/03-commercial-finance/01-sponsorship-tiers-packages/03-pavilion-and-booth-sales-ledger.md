# Pavilion & Booth Sales Ledger

> **Breadcrumb:** [FMF Platform](../../README.md) → [Commercial & Finance](../README.md) → [Sponsorship Tiers & Packages](./README.md) → Pavilion & Booth Sales Ledger

## Purpose

Live sellable inventory, holds, options, and allocations. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Commercial Director and Finance Team.

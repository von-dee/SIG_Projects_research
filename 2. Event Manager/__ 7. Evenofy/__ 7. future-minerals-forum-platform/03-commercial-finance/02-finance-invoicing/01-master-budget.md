...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Commercial & Finance](../README.md) → [Finance & Invoicing](./README.md) → Master Budget

## Purpose

Projected-versus-actual spend by department and cost center. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Commercial & Finance](../README.md) → [Finance & Invoicing](./README.md) → Invoice & PO Center

## Purpose

Multi-currency sponsor invoices, vendor POs, and VAT handling. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

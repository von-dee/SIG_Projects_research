...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Delegate Form Builder](./README.md) → Dynamic Path Setup

## Purpose

Type-specific registration journeys for government, corporate, investor, media, NGO, and academic delegates. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

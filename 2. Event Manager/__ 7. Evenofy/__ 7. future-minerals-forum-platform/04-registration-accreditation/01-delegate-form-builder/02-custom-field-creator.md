...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Delegate Form Builder](./README.md) → Custom Field Creator

## Purpose

Governed field design for identity, organization, mandate, and visa data. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

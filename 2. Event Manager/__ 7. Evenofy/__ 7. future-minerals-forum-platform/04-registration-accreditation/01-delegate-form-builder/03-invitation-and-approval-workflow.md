...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Delegate Form Builder](./README.md) → Invitation & Approval Workflow

## Purpose

Invite-code validation and protocol approval gates for restricted categories. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

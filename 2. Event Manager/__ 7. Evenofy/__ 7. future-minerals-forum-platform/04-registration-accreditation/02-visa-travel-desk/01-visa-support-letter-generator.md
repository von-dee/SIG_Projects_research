# Visa Support Letter Generator

> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Visa & Travel Desk](./README.md) → Visa Support Letter Generator

## Purpose

Embassy-ready official support letters generated from approved identity data. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Registration Team.

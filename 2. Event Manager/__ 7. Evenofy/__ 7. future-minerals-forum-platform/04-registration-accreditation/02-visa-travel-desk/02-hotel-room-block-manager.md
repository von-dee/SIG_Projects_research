# Hotel Room Block Manager

> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Visa & Travel Desk](./README.md) → Hotel Room Block Manager

## Purpose

Delegation-tier allocations within contracted hotel inventory. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

# Airport Transfer Scheduler

> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Visa & Travel Desk](./README.md) → Airport Transfer Scheduler

## Purpose

Flight-linked greet-and-transfer bookings and transport handoffs. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Badge & Check-In](./README.md) → Badge Designer

## Purpose

Tier-coded photo-ID QR badges and VIP lanyard variants. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

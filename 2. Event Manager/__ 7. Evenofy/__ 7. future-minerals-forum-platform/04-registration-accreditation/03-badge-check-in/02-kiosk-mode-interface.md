...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Badge & Check-In](./README.md) → Kiosk Mode Interface

## Purpose

Self-service check-in and badge printing for eligible delegates. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

# VIP Protocol Check-In

> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Badge & Check-In](./README.md) → VIP Protocol Check-In

## Purpose

Private escorted check-in for ministers and heads of state. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

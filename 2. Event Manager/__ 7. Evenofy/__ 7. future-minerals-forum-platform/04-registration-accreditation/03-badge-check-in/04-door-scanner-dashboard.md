# Door Scanner Dashboard

> **Breadcrumb:** [FMF Platform](../../README.md) → [Registration & Accreditation](../README.md) → [Badge & Check-In](./README.md) → Door Scanner Dashboard

## Purpose

Door health, capacity, credential rejections, and offline scanner state. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

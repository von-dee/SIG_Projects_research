...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegations & Bilateral Meetings](../README.md) → [Delegation Manager](./README.md) → Delegation Builder

## Purpose

Group people by country or organization and assign delegation leadership. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

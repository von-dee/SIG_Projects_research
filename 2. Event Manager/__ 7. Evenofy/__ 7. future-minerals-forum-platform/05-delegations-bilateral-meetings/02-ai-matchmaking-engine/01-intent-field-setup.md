...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegations & Bilateral Meetings](../README.md) → [AI Matchmaking Engine](./README.md) → Intent Field Setup

## Purpose

Governed tags for minerals, investment, G2G, technology, and supply-chain objectives. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Protocol Office and Corporate Relations.

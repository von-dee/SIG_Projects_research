...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegations & Bilateral Meetings](../README.md) → [AI Matchmaking Engine](./README.md) → Compatibility Matrix

## Purpose

Explainable scoring between complementary mandates. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

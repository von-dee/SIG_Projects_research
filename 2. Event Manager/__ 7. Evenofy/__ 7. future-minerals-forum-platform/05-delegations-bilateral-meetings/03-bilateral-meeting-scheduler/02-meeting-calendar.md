...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegations & Bilateral Meetings](../README.md) → [Bilateral Meeting Scheduler](./README.md) → Meeting Calendar

## Purpose

Master bilateral bookings with interpreter and note-taker assignment. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

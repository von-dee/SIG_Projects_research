...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegations & Bilateral Meetings](../README.md) → [Bilateral Meeting Scheduler](./README.md) → Interpreter Allocation

## Purpose

Language, shift, qualification, and booth scheduling. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

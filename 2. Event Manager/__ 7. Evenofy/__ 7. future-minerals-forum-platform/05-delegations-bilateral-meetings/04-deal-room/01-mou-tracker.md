...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegations & Bilateral Meetings](../README.md) → [Deal Room](./README.md) → MoU Tracker

## Purpose

Agreements, signing ceremony requirements, witnesses, and evidence. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegations & Bilateral Meetings](../README.md) → [Deal Room](./README.md) → Investment Ledger

## Purpose

Announced values and outcomes feeding verified post-event reporting. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Content, Speakers & Media](../README.md) → [Speaker Portal](./README.md) → Speaker Onboarding

## Purpose

Secure collection of bios, headshots, synopses, and availability. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

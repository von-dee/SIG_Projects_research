...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Content, Speakers & Media](../README.md) → [Speaker Portal](./README.md) → Presentation QA Pipeline

## Purpose

Deck validation, sensitive-content review, version lock, and deadline enforcement. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

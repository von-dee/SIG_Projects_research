...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Content, Speakers & Media](../README.md) → [Live Stage Console](./README.md) → Green Room Status

## Purpose

Traffic-light readiness board for principals and stage progression. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

# Teleprompter & Confidence Monitor Control

> **Breadcrumb:** [FMF Platform](../../README.md) → [Content, Speakers & Media](../README.md) → [Live Stage Console](./README.md) → Teleprompter & Confidence Monitor Control

## Purpose

Controlled content, operator assignment, and output status. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Content Director, Stage Managers, and Press Office.

# Press Release Scheduler

> **Breadcrumb:** [FMF Platform](../../README.md) → [Content, Speakers & Media](../README.md) → [Media & Press Center](./README.md) → Press Release Scheduler

## Purpose

Embargo-aware release queue linked to approved stage moments. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

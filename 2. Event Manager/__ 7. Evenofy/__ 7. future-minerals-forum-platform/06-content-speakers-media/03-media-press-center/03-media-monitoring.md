...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Content, Speakers & Media](../README.md) → [Media & Press Center](./README.md) → Media Monitoring

## Purpose

Live social and press sentiment with escalation rules. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

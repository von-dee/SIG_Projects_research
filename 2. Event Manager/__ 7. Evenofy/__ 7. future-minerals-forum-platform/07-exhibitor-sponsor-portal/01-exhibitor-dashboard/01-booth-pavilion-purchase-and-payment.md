# Booth/Pavilion Purchase & Payment

> **Breadcrumb:** [FMF Platform](../../README.md) → [Exhibitor & Sponsor Portal](../README.md) → [Exhibitor Dashboard](./README.md) → Booth/Pavilion Purchase & Payment

## Purpose

Interactive inventory selection, package upgrade, contract, and payment journey. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Mining houses, OEMs, and service providers.

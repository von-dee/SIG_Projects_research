...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Exhibitor & Sponsor Portal](../README.md) → [Exhibitor Dashboard](./README.md) → Exhibitor Roster

## Purpose

Booth-staff records, dietary needs, and access credential requests. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

# Delegate Database Search

> **Breadcrumb:** [FMF Platform](../../README.md) → [Exhibitor & Sponsor Portal](../README.md) → [Business Development Hub](./README.md) → Delegate Database Search

## Purpose

Consent-aware discovery by mandate, region, organization type, and seniority. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

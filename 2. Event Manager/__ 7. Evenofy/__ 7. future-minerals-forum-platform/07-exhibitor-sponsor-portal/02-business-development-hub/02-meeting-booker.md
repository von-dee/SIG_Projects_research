...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Exhibitor & Sponsor Portal](../README.md) → [Business Development Hub](./README.md) → Meeting Booker

## Purpose

Request and manage 30-minute B2B meetings in suitable private suites. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

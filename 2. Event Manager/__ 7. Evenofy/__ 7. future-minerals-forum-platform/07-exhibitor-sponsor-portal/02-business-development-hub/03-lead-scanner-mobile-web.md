# Lead Scanner (Mobile Web)

> **Breadcrumb:** [FMF Platform](../../README.md) → [Exhibitor & Sponsor Portal](../README.md) → [Business Development Hub](./README.md) → Lead Scanner (Mobile Web)

## Purpose

Camera-based QR capture with consent and stated-interest data. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

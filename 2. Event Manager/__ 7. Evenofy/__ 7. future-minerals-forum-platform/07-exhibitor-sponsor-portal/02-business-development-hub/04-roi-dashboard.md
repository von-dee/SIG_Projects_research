...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Exhibitor & Sponsor Portal](../README.md) → [Business Development Hub](./README.md) → ROI Dashboard

## Purpose

Leads, meetings, pipeline, and outcomes after the forum. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegate Portal](../README.md) → [Delegate Dashboard](./README.md) → Registration & Profile

## Purpose

Complete profile, credentials, mandate, and visa-letter request. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegate Portal](../README.md) → [Delegate Dashboard](./README.md) → Personalized Agenda

## Purpose

Save and manage plenaries, roundtables, and pavilion visits. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegate Portal](../README.md) → [Networking & Meetings](./README.md) → Matched Delegates

## Purpose

Complementary, privacy-safe suggested connections. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

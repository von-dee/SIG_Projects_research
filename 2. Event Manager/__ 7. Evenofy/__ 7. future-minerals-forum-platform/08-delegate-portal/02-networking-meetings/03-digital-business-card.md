...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegate Portal](../README.md) → [Networking & Meetings](./README.md) → Digital Business Card

## Purpose

Time-bound QR identity for permissioned networking. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegate Portal](../README.md) → [On-Site Tools](./README.md) → Interactive Venue Map

## Purpose

Accessible navigation to halls, pavilions, prayer rooms, and amenities. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

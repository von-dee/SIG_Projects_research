...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegate Portal](../README.md) → [On-Site Tools](./README.md) → Live Translation Toggle

## Purpose

Session audio stream selection in the delegate’s preferred language. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Registered attendees on web and mobile.

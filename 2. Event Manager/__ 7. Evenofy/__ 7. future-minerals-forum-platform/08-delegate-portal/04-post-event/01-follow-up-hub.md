...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Delegate Portal](../README.md) → [Post-Event](./README.md) → Follow-Up Hub

## Purpose

Contacts, approved recordings, resources, and outcome survey. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

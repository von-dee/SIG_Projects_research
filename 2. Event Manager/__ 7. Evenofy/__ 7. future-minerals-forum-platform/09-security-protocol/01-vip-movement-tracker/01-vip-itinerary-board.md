...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Security & Protocol](../README.md) → [VIP Movement Tracker](./README.md) → VIP Itinerary Board

## Purpose

Authoritative arrival, transport, greeter, and next-session view for principals. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

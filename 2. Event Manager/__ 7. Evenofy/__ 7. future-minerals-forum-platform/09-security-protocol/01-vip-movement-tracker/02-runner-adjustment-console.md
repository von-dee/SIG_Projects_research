# Runner Adjustment Console

> **Breadcrumb:** [FMF Platform](../../README.md) → [Security & Protocol](../README.md) → [VIP Movement Tracker](./README.md) → Runner Adjustment Console

## Purpose

Controlled changes to VIP timing without corrupting the master ROS. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Security Director, Protocol Office, and national-security liaisons.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Security & Protocol](../README.md) → [Accreditation & Access Control](./README.md) → Clearance Levels

## Purpose

Zone entitlement enforcement across badges, doors, and workflows. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

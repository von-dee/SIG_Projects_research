# Security Detail Registry

> **Breadcrumb:** [FMF Platform](../../README.md) → [Security & Protocol](../README.md) → [Accreditation & Access Control](./README.md) → Security Detail Registry

## Purpose

Advance-team, close-protection, equipment, and contact records. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

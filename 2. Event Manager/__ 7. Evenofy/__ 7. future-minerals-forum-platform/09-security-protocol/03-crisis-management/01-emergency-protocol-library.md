...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Security & Protocol](../README.md) → [Crisis Management](./README.md) → Emergency Protocol Library

## Purpose

Version-controlled medical, evacuation, and lockdown playbooks by zone. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Security & Protocol](../README.md) → [Crisis Management](./README.md) → Broadcast Alerts

## Purpose

Approved critical alert distribution to staff apps and dispatch channels. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

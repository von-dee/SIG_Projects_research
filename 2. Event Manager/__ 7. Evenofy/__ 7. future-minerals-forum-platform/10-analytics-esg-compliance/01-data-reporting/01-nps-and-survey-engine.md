...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [Data & Reporting](./README.md) → NPS & Survey Engine

## Purpose

Automated surveys, governed distribution, and sentiment analysis. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

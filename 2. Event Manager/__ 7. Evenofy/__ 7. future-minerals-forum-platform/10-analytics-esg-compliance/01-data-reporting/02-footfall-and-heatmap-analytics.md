...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [Data & Reporting](./README.md) → Footfall & Heatmap Analytics

## Purpose

Privacy-controlled traffic and dwell-time analysis for pavilions and sessions. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

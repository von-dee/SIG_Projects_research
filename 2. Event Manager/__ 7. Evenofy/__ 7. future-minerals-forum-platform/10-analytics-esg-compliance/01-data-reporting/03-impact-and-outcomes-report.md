...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [Data & Reporting](./README.md) → Impact & Outcomes Report

## Purpose

Verified meetings, MoUs, and facilitated-investment outcomes. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

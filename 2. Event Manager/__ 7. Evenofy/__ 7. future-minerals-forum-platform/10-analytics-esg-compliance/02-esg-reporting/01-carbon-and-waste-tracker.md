# Carbon & Waste Tracker

> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [ESG Reporting](./README.md) → Carbon & Waste Tracker

## Purpose

Emissions, offsets, waste diversion, and catering sourcing evidence. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [ESG Reporting](./README.md) → Diversity Metrics

## Purpose

Speaker and participation balance across gender and nationality. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [ESG Reporting](./README.md) → Sustainability Certification Evidence

## Purpose

ISO 20121 evidence register, owners, and audit-ready exports. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

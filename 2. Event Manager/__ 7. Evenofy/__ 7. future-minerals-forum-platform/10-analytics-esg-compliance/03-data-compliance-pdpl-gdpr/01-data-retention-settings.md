...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [Data Compliance (PDPL / GDPR)](./README.md) → Data Retention Settings

## Purpose

Retention schedules and irreversible purge workflows for sensitive information. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Event Director, Government Stakeholders, and Audit.

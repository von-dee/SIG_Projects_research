# Consent & Sharing Logs

> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [Data Compliance (PDPL / GDPR)](./README.md) → Consent & Sharing Logs

## Purpose

Immutable evidence of contact-data sharing consent. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

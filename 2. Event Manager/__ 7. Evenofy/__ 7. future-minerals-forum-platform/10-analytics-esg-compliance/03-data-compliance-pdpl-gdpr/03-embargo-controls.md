...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Analytics, ESG & Compliance](../README.md) → [Data Compliance (PDPL / GDPR)](./README.md) → Embargo Controls

## Purpose

Restrict recordings, materials, and exports for closed sessions. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

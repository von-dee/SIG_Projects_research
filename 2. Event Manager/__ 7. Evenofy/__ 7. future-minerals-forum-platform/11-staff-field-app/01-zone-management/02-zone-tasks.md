...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Staff Field App](../README.md) → [Zone Management](./README.md) → Zone Tasks

## Purpose

Assigned duties, acknowledgement, completion, and escalation. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

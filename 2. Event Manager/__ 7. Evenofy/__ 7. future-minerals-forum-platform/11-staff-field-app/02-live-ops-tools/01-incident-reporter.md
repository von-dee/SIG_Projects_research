...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Staff Field App](../README.md) → [Live Ops Tools](./README.md) → Incident Reporter

## Purpose

Fast classified incident report with location, photos, and dispatch routing. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Staff Field App](../README.md) → [Live Ops Tools](./README.md) → Crowd Control Scanner

## Purpose

Offline-capable badge scan and room-capacity tracking. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

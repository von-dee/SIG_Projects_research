...
> **Breadcrumb:** [FMF Platform](../../README.md) → [Staff Field App](../README.md) → [Live Ops Tools](./README.md) → VIP Runner Mode

## Purpose

Restricted principal arrival/departure signals that trigger protocol workflows. This is an operational page, not merely a report: authorised users can identify an exception, trace its source, and take the next permitted action without leaving the FMF platform.

## Users and access

- **Primary users:** Event-day staff and volunteers.
